...
paquetes<-c("stringr","stringi", "lubridate", "ggplot2", "dplyr", "plotly", "rgdal", "leaflet", "htmlwidgets", "htmltools", "tidytext", "tidyverse", "wordcloud", "DT")
...
graf_fuente <- ggplot(total_x_fuente[total_x_fuente$Freq > 100,], aes(x=Organizacion, y=Freq, fill=Freq)) +
  geom_bar(stat="identity") + 
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  ggtitle("Cantidad de reportes por Organización (organizaciones con más de 100 reportes)") +
